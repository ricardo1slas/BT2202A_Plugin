...
namespace childStep
{
    ...
    public class DurationTestStep : TestStep
    {
        ...
        private static readonly Dictionary<Compare, string> CompareMapping = new()
        {
            { Compare.GreaterThanOrEqual, "GE" },
            { Compare.LessThanOrEqual, "LE" }
        };

        private static readonly Dictionary<When, string> WhenMapping = new()
        {
            { When.Before, "BEFORE" },
            { When.After, "AFTER" },
            { When.At, "AT" }
        ...
        private static readonly Dictionary<TestType, string> TestTypeMapping = new()
        {
        ...
        public override void Run()
        {
            ...
            string parameterComparison = $"{TestTypeMapping[SelectedTestType]}_{CompareMapping[ComparisonOperator]}";
            ...
            string scpiCommand = $"SEQ:TEST:DEF {fixedValues},{parameterComparison},{parameterValue},{whenCondition},{Time},{resultAction}";
